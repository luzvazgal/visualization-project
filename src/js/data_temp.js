...
data = [
    {
        ...
        Inbound:{
                Tourist_Inbound: [6724.5, 7138.2, 7852.9, 8557.554, 9071.7],
                Top_Markets: { 
        ...
        Outbound: {
                Tourist_Outbound : [8986.7, 9262.5, 9665.3, 10297.2, 10759.4],
                Top_Destinations: {
...

{
    ...
    Years: [2014,2015,2016,2017,2018],
    Inbound:{
            Tourist_Inbound: [2865.988, 3252.276, 3559.471, 3975.57, 4281.851],
            Top_Markets: { 
...

{
    ...
    Years: [2014,2015,2016,2017,2018],
    Inbound:{
            Tourist_Inbound: [55169.361469999996,
                57418.064,
                57479.628,
                60042.386963,
                61194.642534],
